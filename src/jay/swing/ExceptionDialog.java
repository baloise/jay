...
public class ExceptionDialog extends JDialog implements ClipboardOwner {
	...
	public ExceptionDialog(Frame owner, Throwable exception, String extraMessage) {
		...
		JLabel messageLabel = new JLabel("<html><b>Error: </b>"
				+ exception.getClass().getName() + ": "
				+ exception.getMessage() + " " + extraMessage + "</html>");
		...
		JPanel buttonPanel = new JPanel(new FlowLayout(FlowLayout.TRAILING, 10,
				10));
